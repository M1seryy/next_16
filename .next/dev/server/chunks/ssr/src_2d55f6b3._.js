...
const bookByIdQueryApi = async (opt, queryParams)=>{
    ...
    try {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pkg$2f$libraries$2f$rest$2d$api$2f$fetcher$2f$rest$2d$api$2e$fetcher$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["restApiFetcher"].get(`api/books/${id}`, {
            signal: opt.signal,
            cache: 'force-cache',
            next: {
                revalidate: 30
...
//# sourceMappingURL=src_2d55f6b3._.js.map