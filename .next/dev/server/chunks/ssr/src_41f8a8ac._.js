...
const AuthBlockComponent = ()=>{
    ...
    const handleGoogleSignIn = async ()=>{
        try {
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$entities$2f$auth$2f$authClient$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["authClient"].signIn.social({
                provider: 'google',
                callbackURL: '/'
            });
        } catch (error) {
...
//# sourceMappingURL=src_41f8a8ac._.js.map