...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pkg$2f$libraries$2f$rest$2d$api$2f$rest$2d$api$2e$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/pkg/libraries/rest-api/rest-api.provider.tsx [app-client] (ecmascript)");
...
"[project]/src/pkg/libraries/rest-api/index.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "RestApiProvider",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pkg$2f$libraries$2f$rest$2d$api$2f$rest$2d$api$2e$provider$2e$tsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"],
    "getQueryClient",
    ()=>__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pkg$2f$libraries$2f$rest$2d$api$2f$service$2f$rest$2d$api$2e$service$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getQueryClient"]
]);
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pkg$2f$libraries$2f$rest$2d$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__ = __turbopack_context__.i("[project]/src/pkg/libraries/rest-api/index.ts [app-client] (ecmascript) <locals>");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pkg$2f$libraries$2f$rest$2d$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/pkg/libraries/rest-api/index.ts [app-client] (ecmascript)");
;
const booksQueryApi = async (opt, queryParams)=>{
    const { search } = queryParams || {};
    try {
        const url = search ? `api/books?search=${encodeURIComponent(search)}` : 'api/books';
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pkg$2f$libraries$2f$rest$2d$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["restApiFetcher"].get(url, {
            signal: opt.signal,
            cache: 'force-cache',
            next: {
                revalidate: 30
...
const bookByIdQueryApi = async (opt, queryParams)=>{
    ...
    try {
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$pkg$2f$libraries$2f$rest$2d$api$2f$index$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["restApiFetcher"].get(`api/books/${id}`, {
            signal: opt.signal,
            cache: 'force-cache',
            next: {
                revalidate: 30
...
const HomeModule = (props)=>{
    ...
    if ($[0] !== "a28f48e6ef1421299f308a265d518825aff50e425a892bf519b74747caa04254") {
        for(let $i = 0; $i < 19; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "a28f48e6ef1421299f308a265d518825aff50e425a892bf519b74747caa04254";
    }
    const { searchQuery: t0 } = props;
    const searchQuery = t0 === undefined ? "" : t0;
    const t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$intl$2f$dist$2f$esm$2f$development$2f$react$2d$client$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useTranslations"])();
...
//# sourceMappingURL=_0a6864b4._.js.map