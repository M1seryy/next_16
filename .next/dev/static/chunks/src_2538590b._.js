...
const CustomCardComponent = (props)=>{
    ...
    if ($[0] !== "fadee3d1a7c437a2ddb5da33769a695ceb70302610424adbd7ee381a7d9c3750") {
        for(let $i = 0; $i < 27; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "fadee3d1a7c437a2ddb5da33769a695ceb70302610424adbd7ee381a7d9c3750";
    }
    const { title, author, publishedYear, description, href, isFavorite: t0 } = props;
    const isFavorite = t0 === undefined ? false : t0;
    const t1 = href ?? "/";
    let t2;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
        t2 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$shared$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("group block");
        $[1] = t2;
    } else {
        t2 = $[1];
    }
...
const FavoriteToggle = (props)=>{
    ...
    if ($[0] !== "df88f926dc4025c711893d3919ef3d8ea5c183daf0ebe3694d989fbe76a83e2e") {
        for(let $i = 0; $i < 23; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "df88f926dc4025c711893d3919ef3d8ea5c183daf0ebe3694d989fbe76a83e2e";
    }
    ...
    const t4 = isActive ? "text-red-500 hover:text-red-600" : "text-muted-foreground hover:text-foreground";
    let t5;
    if ($[3] !== t4) {
        t5 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$shared$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("transition-colors", t4);
        $[3] = t4;
        $[4] = t5;
    } else {
        t5 = $[4];
    }
    const t6 = isActive ? "Remove from favorites" : "Add to favorites";
    const t7 = isActive && "fill-red-500";
    let t8;
    if ($[5] !== t7) {
        t8 = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$shared$2f$lib$2f$utils$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["cn"])("h-5 w-5", t7);
        $[5] = t7;
        $[6] = t8;
    } else {
        t8 = $[6];
    ...
    let t10;
    if ($[9] !== isActive || $[10] !== loading || $[11] !== onToggle || $[12] !== t3 || $[13] !== t5 || $[14] !== t6 || $[15] !== t9) {
    ...
    let t11;
    if ($[17] !== count) {
        t11 = typeof count === "number" && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
            className: "text-muted-foreground text-sm",
            children: count
        }, void 0, false, {
            fileName: "[project]/src/app/shared/ui/components/favourite-toggle/favourite-toggle.tsx",
...
const BooksListBlockComponent = (props)=>{
    ...
    if ($[0] !== "5a3edbcb5e0ea2d42b7d00153844e9ba1a4e78e99dd7be07e613211d9726c702") {
        for(let $i = 0; $i < 7; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "5a3edbcb5e0ea2d42b7d00153844e9ba1a4e78e99dd7be07e613211d9726c702";
    }
...
const HeaderComponent = ()=>{
    _s();
    const $ = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$compiler$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["c"])(10);
    if ($[0] !== "e2cf3cb26ac066190f2da3c0c041c223fc15a1015eacc03772f86f7918f6ac09") {
        for(let $i = 0; $i < 10; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "e2cf3cb26ac066190f2da3c0c041c223fc15a1015eacc03772f86f7918f6ac09";
    }
    const t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$intl$2f$dist$2f$esm$2f$development$2f$react$2d$client$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useTranslations"])();
    let t0;
    if ($[1] === Symbol.for("react.memo_cache_sentinel")) {
...
//# sourceMappingURL=src_2538590b._.js.map