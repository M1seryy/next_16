...
const useBooksQuery = (searchQuery)=>{
    ...
    if ($[0] !== "ad2714bb32fbc1f69ea9357015eb285f2d483a2cf0f948d1f1c9832cb0935197") {
        for(let $i = 0; $i < 8; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "ad2714bb32fbc1f69ea9357015eb285f2d483a2cf0f948d1f1c9832cb0935197";
    }
    let t0;
    if ($[1] !== searchQuery) {
        t0 = booksKeys.list(searchQuery);
        $[1] = searchQuery;
        $[2] = t0;
    } else {
        t0 = $[2];
...
const useBookQuery = (id)=>{
    ...
    let t1;
    if ($[3] !== id) {
        t1 = (opt)=>(0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$app$2f$entities$2f$api$2f$books$2f$books$2e$api$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["bookByIdQueryApi"])(opt, {
                id
            });
        $[3] = id;
        $[4] = t1;
...
_s1(useBookQuery, "4ZpngI1uv+Uo3WQHEZmTQ5FNM+k=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"]
    ];
});
...
//# sourceMappingURL=_2d403054._.js.map