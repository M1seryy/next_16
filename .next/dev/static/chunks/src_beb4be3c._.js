...
const AuthBlockComponent = ()=>{
    ...
    if ($[0] !== "fb6de2cbdcaba90afa54626cab8f6536e7a18e6ab891367d7a00181a60a7c33e") {
        for(let $i = 0; $i < 12; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "fb6de2cbdcaba90afa54626cab8f6536e7a18e6ab891367d7a00181a60a7c33e";
    }
    const t = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$intl$2f$dist$2f$esm$2f$development$2f$react$2d$client$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useTranslations"])();
...
_s(AuthBlockComponent, "h6+q2O3NJKPY5uL0BIJGLIanww8=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2d$intl$2f$dist$2f$esm$2f$development$2f$react$2d$client$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__$3c$locals$3e$__["useTranslations"]
    ];
});
...
const HomeModule = (props)=>{
    ...
    if ($[0] !== "2a39a2b88bf6fb31ace347d39a275ffa559dcf7557dfcfda0d01fc9246c05fef") {
        for(let $i = 0; $i < 23; $i += 1){
            $[$i] = Symbol.for("react.memo_cache_sentinel");
        }
        $[0] = "2a39a2b88bf6fb31ace347d39a275ffa559dcf7557dfcfda0d01fc9246c05fef";
    }
    const { searchQuery: t0 } = props;
...
//# sourceMappingURL=src_beb4be3c._.js.map